...
const ConsultingStrategy: React.FC = () => {
  ...
  return (
    <div className="w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-8 font-light">
                Traditional risk management is focused on the next 12 months. Our integrated strategy and execution model focuses on the next 60 months. We help plan sponsors and advisors transition from transactional procurement to strategic risk ownership.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-sm font-bold text-zenith-navy uppercase tracking-widest">Integrated clinical oversight</span>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-sm font-bold text-zenith-navy uppercase tracking-widest">Proactive vendor alignment</span>
                </div>
              </div>
            </div>
      ...
      {/* Strategy Brochure Section */}
      <section className="py-20 bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <span className="text-[11px] font-black text-blue-600 uppercase tracking-[0.4em] mb-4 block">Resources</span>
          <h2 className="text-3xl font-bold text-zenith-navy mb-4">Strategy Brochure</h2>
          <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto font-light">
            Download our comprehensive strategy brochure to learn more about how Zenith delivers proactive risk strategy, embedded support, and long-term performance optimization.
          </p>
          <a 
            href={STRATEGY_BROCHURE_URL}
            download
          ...
          >
            ...
            <span className="relative z-10 flex items-center">
              Download Brochure
              <svg className="ml-3 w-5 h-5 group-hover:translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
