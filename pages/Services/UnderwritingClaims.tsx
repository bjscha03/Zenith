...
const UnderwritingClaims: React.FC = () => {
  return (
    <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="premium-hero-copy max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight tracking-tight mb-8">
              ...
              <span className="text-blue-400 italic underline underline-offset-8 decoration-4 decoration-blue-500/50">Before</span> It Hits the Claims File.
            </h1>
      ...
      <ClosingCta
        eyebrow="Underwriting partnership"
        title="Ready to optimize your plan?"
        description="Share the group profile and let Zenith connect pricing discipline with practical clinical oversight."
        primary={{ label: 'Submit a group', to: '/contact' }}
      />
    </div>
  );
};
