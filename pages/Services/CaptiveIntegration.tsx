    ...
    <div className="w-full">
      ...
      <section className="premium-light-section py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="premium-card overflow-hidden rounded-[1.75rem] shadow-xl bg-white">
      ...
      <section className="premium-dark-section py-20 md:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {/* Card 1: Employers */}
            <div className="premium-card-dark rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
      ...
      <section className="premium-light-section py-20 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="premium-card rounded-2xl p-6">
              ...
              <h3 className="text-lg font-bold text-zenith-navy mb-2">Captive Insurer</h3>
              <p className="text-sm text-slate-600 mb-3">Retains risk and manages claims</p>
              <div className="text-xs text-blue-600 font-semibold uppercase tracking-wide">Risk Retention →</div>
            </div>
      ...
      <section className="premium-dark-section py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="premium-card-dark relative p-10 rounded-3xl shadow-lg">
