...
export function assertHolidayAccess(value: unknown) {
  // The clean event page is deliberately unlisted, not identity-authenticated.
  // Earlier random-key links remain valid for invitations already distributed.
  if (value === 'holiday-celebration') return;
